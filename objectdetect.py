...
# สีของกรอบ(randomทุกครั้ง)
COLORS = np.random.uniform(0, 100, size=(len(CLASSES), 3))

# import files to model
net = cv2.dnn.readNetFromCaffe(
    "MobileNetSSD/MobileNetSSD.prototxt", "MobileNetSSD/MobileNetSSD.caffemodel")
    ...
    if ret:
        ...
        for i in np.arange(0, detections.shape[2]):
            ...
            if percent > 0.8:
                ...
                cv2.circle(frame, (centerX,centerY), 15, (0,255,0), -1)
